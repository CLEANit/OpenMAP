...
class Logger:
    ...
    The |Logger| is the analysis object of ``loguru``, every logging configuration and usage pass
    ...
    def opt(
        ...
        *,
        ...
        -------
        :class:`~Logger`
            A logger wrapping the analysis logger, but transforming logged message adequately before
            sending.
    ...
    def bind(__self, **kwargs):
        ...
        **kwargs
        ...
        -------
        :class:`~Logger`
            A logger wrapping the analysis logger, but which sends record with the customized ``extra``
            dict.
    ...
    def patch(self, patcher):
        ...
        -------
        :class:`~Logger`
            A logger wrapping the analysis logger, but which records are passed through the ``patcher``
    ...
    def configure(self, *, handlers=None, levels=None, extra=None, patcher=None, activation=None):
        ...
        levels : |list| of |dict|, optional
            ...
            created levels.
        extra : |dict|, optional
            A dict containing additional parameters bound to the analysis logger, useful to share
